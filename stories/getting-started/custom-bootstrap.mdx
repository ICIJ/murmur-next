...
import rawVariables from '../../lib/styles/variables.scss?raw';

<Meta title="Customize Boostrap"/>

## Use pre-configured variables to build Boostrap.
...
// Optional but recommended: Bootstrap Vue Next CSS additions
@import 'node_modules/bootstrap-vue-next/dist/bootstrap-vue.css';
```
...
<pre ><code>{rawVariables}</code></pre>
